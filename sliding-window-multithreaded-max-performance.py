...
num_workers = 12  # You can experiment with 8, 10, or 12 workers depending on your M3 Max capacity
...
# For future dates, Actual Sale and Difference should remain None; For test data, fill missing Difference columns
output_forecast['Difference'] = output_forecast['Difference'].fillna(0)
output_forecast['Difference %'] = output_forecast['Difference %'].fillna(0)
...
output_forecast.to_csv('forecasted_inventory_parallel_max_performance.csv', index=False)
